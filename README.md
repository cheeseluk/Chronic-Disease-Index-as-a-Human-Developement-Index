...
<img width="790" height="1489" alt="best model mse" src="https://github.com/user-attachments/assets/6ac0d222-8934-485c-a7de-e910b403840b" />

*Fig. 6 — Mean squared error of the best KNN model as more disease features are added, for each of the three targets. Error drops sharply through the first few features, then flattens (and for GNI, ticks back up) once enough diseases are included — the basis for the 5-6 column above.*
